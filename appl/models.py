...
class EducationalProfile(models.Model):
    EDUCATION_LEVEL_CHOICES = [
        ...
        (101,'เป็นผู้สำเร็จการศึกษาระดับปริญญาตรีขึ้นไป'),
        (102,'เป็นนิสิตที่กำลังจะสำเร็จการศึกษาระดับปริญญาตรี ม.เกษตรศาสตร์ ภาคปลาย 2561'),
        (103,'เป็นผู้มีประสบการณ์การทำงานตรง โดยมีประวัติผลงานเชิงประจักษ์ในชุดวิชาที่สมัคร'),
    ]
