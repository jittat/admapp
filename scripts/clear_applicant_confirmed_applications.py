...
def main():
    ...
    applicants = (Applicant.objects.filter(confirmed_application__isnull=False)
                           .select_related('confirmed_application')
                           .all())    

    count = 0

    for applicant in applicants:
        application = applicant.confirmed_application
