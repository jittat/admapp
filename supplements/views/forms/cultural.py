...
EXAM_CHOICES = [
    ...
    'นาฏศิลป์ไทย - ละครนาง',
    'นิสิตอีสาน - กีตาร์',
    'นิสิตอีสาน - เปียโนหรือคีย์บอร์ด',
    'นิสิตอีสาน - เบส',
    'นิสิตอีสาน - กลองชุด',
    'นิสิตอีสาน - เครื่องดนตรีพื้นบ้านพื้นเมืองอีสาน',
    'นิสิตอีสาน - ขับร้องเพลงไทยลูกทุ่ง',
    'นิสิตอีสาน - นาฏศิลป์พื้นเมืองภาคอีสาน',
    'ดนตรีไทย - ระนาดเอก ระนาดทุ้ม',
    'ดนตรีไทย - ฆ้องวงใหญ่ ฆ้องวงเล็ก',
    'ดนตรีไทย - ปี่ใน ขลุ่ย',
    'ดนตรีไทย - ตะโพนไทย กลองแขก กลองทัด',
    'ดนตรีไทย - ซอด้วง ซออู้',
    'ดนตรีไทย - จะเข้ ขิม',
    'ดนตรีไทย - ขับร้องเพลงไทยเดิม',
    'วงดนตรีรวมดาวกระจุย - Trumpet Trombone Alto saxophone Tenner saxophone',
    'วงดนตรีรวมดาวกระจุย - กลองชุด',
    'วงดนตรีรวมดาวกระจุย - กีตาร์',
    'วงดนตรีรวมดาวกระจุย - เบส',
    'วงดนตรีรวมดาวกระจุย - คีย์บอร์ด',
    'วงดนตรีรวมดาวกระจุย - ขับร้องเพลงไทยลูกทุ่ง',
    'โขนละคอน - ตัวพระ (โขนหรือละคร)',
    'โขนละคอน - ตัวนาง (โขนหรือละคร)',
    'โขนละคอน - ตัวยักษ์',
    'โขนละคอน - ตัวลิง',
    ...
    'ขับร้องประสานเสียงแห่งมหาวิทยาลัยเกษตรศาสตร์ - นักร้องชายที่เป็นเสียงเบส',
    'วงดนตรีสากล มหาวิทยาลัยเกษตรศาสตร์ - เปียโนหรือคีย์บอร์ด',
    'วงดนตรีสากล มหาวิทยาลัยเกษตรศาสตร์ - เบส',
    'วงดนตรีสากล มหาวิทยาลัยเกษตรศาสตร์ - กลองชุด',
