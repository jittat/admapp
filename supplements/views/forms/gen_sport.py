...
GEN_SPORT_LEVEL_CHOICES = [
    ...
    ('206', 'นักกีฬาที่เข้าแข่งขันกีฬามหาวิทยาลัยแห่งประเทศไทย หรีอกีฬาอุดมศึกษา ได้อันดับที่ 1 - 3'),
    ('207', 'นักกีฬาที่เข้าแข่งขันกีฬาเยาวชนแห่งชาติ ได้อันดับที่ 1 - 3 (รอบการแข่งขันระดับประเทศเท่านั้น)'),
    ('208', 'นักกีฬาตัวแทนนักเรียนเข้าแข่งขันกีฬาในระดับนานาชาติ ที่ดำเนินการโดยกรมพลศึกษา'),
    ('209', 'นักกีฬาที่เข้าแข่งขันชิงชนะเลิศแห่งประเทศไทย ประเภทเยาวชน ได้อันดับที่ 1 - 3 ในการแข่งขันที่สมาคมกีฬาแห่งประเทศไทยเป็นผู้จัด'),
    ('210', 'นักกีฬาที่เข้าแข่งขันในรายการแข่งขันกีฬาที่มหาวิทยาลัยเกษตรศาสตร์จัดการแข่งขันโดยการรับรองของสมาคมกีฬานั้นๆ ได้อันดับที่ 1 - 3'),
    ('211', 'นักกีฬาที่เข้าแข่งขันในรายการแข่งขันกีฬานักเรียนนักศึกษาแห่งชาติ ได้อันดับที่ 1 - 3 (รอบการแข่งขันระดับประเทศเท่านั้น)'),
    ('212', 'นักกีฬาที่เข้าแข่งขันกีฬานักเรียนการศึกษาขั้นพื้นฐาน ได้อันดับที่ 1 - 3 (รอบการแข่งขันระดับประเทศเท่านั้น)'),
    ('213', 'นักกีฬาที่เข้าแข่งขันในการแข่งขันกีฬากรมพลศึกษา ได้อันดับที่ 1 - 3'),
    ('214', 'นักกีฬาที่เข้าแข่งขันในรายการแข่งขันกีฬาระหว่างโรงเรียนกีฬา ได้อันดับที่ 1 (รอบการแข่งขันระดับประเทศเท่านั้น)'),
    ('215', 'นักกีฬาที่เข้าแข่งขันในการแข่งขันกีฬากรุงเทพมหานคร ได้อันดับที่ 1'),
    ('216', 'นักกีฬาที่เข้าแข่งขันในรายการแข่งขันกีฬาสาธิตสามัคคี ได้อันดับที่ 1'),
    ('217', 'นักกีฬาที่เข้าแข่งขันกีฬาดาวรุ่งที่จัดการแข่งขันโดยสมาคมกีฬาแห่งประเทศไทย ได้อันดับที่ 1'),
    ('218', 'นักกีฬาที่เข้าแข่งขันในรายการแข่งขันที่มหาวิทยาลัยเกษตรศาสตร์กำหนด'),
]
